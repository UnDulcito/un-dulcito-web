...
export default function FloatingWhatsapp() {
  ...
  return (
    ...
    >
      ...
      {/* Tooltip opcional */}
      <span className="absolute right-full mr-3 bg-white text-warm-charcoal text-xs font-bold px-2 py-1 rounded-md shadow-sm whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none hidden md:block">
        ¡Escríbenos!
      </span>
    </motion.a>
  );
